...
class AccountSecurityPage extends StatefulWidget {
  const AccountSecurityPage({super.key, required this.authController});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                labelText: l10n.securityNextPassword,
                              ),
                              obscureText: true,
                            ),
                            if (widget.authController.securityError !=
                                null) ...[
                              const SizedBox(height: 12),
                              Text(
                                _securityErrorText(
                                  l10n,
                                  widget.authController.securityError!,
                                ),
                          ...
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    l10n.securityDevicesTitle,
                                    style: theme.textTheme.headlineSmall,
                                  ),
                                ),
                                IconButton(
                                  onPressed:
                                      widget.authController.isSecurityBusy
                                      ? null
                                      : widget
                                            .authController
                            ...
                            const SizedBox(height: 8),
                            Text(
                              l10n.securityDevicesBody,
                              style: theme.textTheme.bodyLarge,
                            ),
                            const SizedBox(height: 16),
                            for (final device
                                in widget.authController.deviceSessions)
                              ListTile(
...
class _SecurityInfoRow extends StatelessWidget {
  const _SecurityInfoRow({required this.label, required this.value});
